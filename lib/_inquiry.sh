...
inquiry_options() {
  ...
  printf "\n\n"
  printf "  [1] Instalar a crmplus\n"
  printf "  [2] Atualizar a crmplus para última versão\n"
  printf "  [3] Atualizar instâncias secundárias da crmplus para última versão (Beta)\n"
  # printf "  [3] Migrar do IzingPro para o crmplus\n"
  # printf "  [4] Migrar do WhaticketPro para o crmplus\n"
  # printf "  [5] Migrar do GroupsPro para o crmplus\n"
